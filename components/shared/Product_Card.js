...
const Product_Card = ({ productName, description, image }) => {
  ...
  return (
    ...
    transition-all duration-500" style={{ background: 'linear-gradient(to bottom, #0A0A0A 100%, #302E2E 24%)' }}>
      ...
      <div className="p-5">
        ...
        <a href="#" className="inline-flex items-center px-3 py-2 text-sm text-center font-bold text-white bg-[#3877F0] rounded-lg mb-auto">
          Learn more
