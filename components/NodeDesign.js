              ...
              const ServiceCard = () => {
                ...
                return (
                  <div className="relative flex items-center justify-center w-full">
                    ...
                    >
                      <motion.div
                        className={`group relative max-w-lg w-full p-8 text-white bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden transition-all duration-500 hover:border-[#308fef]/50 hover:bg-white/10 hover:shadow-[0_0_40px_rgba(48,143,239,0.15)] hover:-translate-y-2`}
                      ...
                      >
                        ...
                        <div className="absolute -inset-10 bg-gradient-to-br from-[#308fef]/10 via-[#4460ef]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-2xl pointer-events-none" />

                        <div className="relative z-10 flex flex-row justify-between items-start mb-6">
                          <div>
                            <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400 group-hover:from-[#4ec8ef] group-hover:to-[#308fef] transition-all duration-500">
                                {service.title}
                            </h2>
                            <div className="w-12 h-1 bg-gradient-to-r from-[#4ec8ef] to-[#308fef] rounded-full mt-4 opacity-50 group-hover:opacity-100 group-hover:w-20 transition-all duration-500" />
                          </div>
                          {service.logo && (
                            <div className="w-16 h-16 p-3 rounded-2xl bg-white/5 border border-white/10 shadow-inner group-hover:scale-110 group-hover:border-[#308fef]/30 transition-all duration-500">
                              <Image
                                src={service.logo}
                        ...
                        <div className="relative z-10 flex items-center">
                          <button className="px-6 py-2.5 rounded-full bg-white/5 border border-white/10 text-sm font-semibold text-white group-hover:bg-[#308fef] group-hover:border-[#308fef] group-hover:text-white transition-all duration-500 flex items-center gap-2">
                            Learn More
