        ...
        <div className="relative lg:h-[700px] bg-black text-white flex flex-col items-center">
            ...
            <motion.div
                ...
                <div className="flex flex-col justify-center my-7">
                    ...
                    <button className="bg-[#003FB9] px-10 py-2 rounded-xl border-3 border-[#3877F0]/60 hover:bg-[#3877F0] hover:border-[#003FB9] mx-auto opacity-95 duration-300 ease-in">
                        Contact Us
                    </button>
                </div>
            </motion.div>
