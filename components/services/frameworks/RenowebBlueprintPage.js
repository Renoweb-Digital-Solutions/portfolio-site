...
/* ════════════════════════════════════════════════════════════════════
   RENOWEB BLUEPRINT PAGE
   ════════════════════════════════════════════════════════════════════ */
export default function RenowebBlueprintPage() {
    ...
    const sections = [
        {
            step: 1,
            title: 'The Positioning Map',
            description: 'Captures Why (belief), What (offering), How (mechanism), and Key Pillars (the 3–4 non-negotiables that separate the brand from the pack), plus persona-specific benefit statements.',
            image: '/frameworks/brand-blueprint/1.png',
            imageAlt: 'The Positioning Map',
            angles: ['Why (Belief)', 'What (Offering)', 'How (Mechanism)', 'Key Pillars', 'Benefit Statements'],
        },
        {
            step: 2,
            title: 'The Situational Response Map',
            description: 'Maps how the brand should show up across real buying scenarios (new-category consideration, competitive comparison, upgrade decisions, launches, negative publicity, prior loyalty to a competitor) rather than a single generic message for every scenario.',
            image: '/frameworks/brand-blueprint/2.png',
            imageAlt: 'The Situational Response Map',
        },
        {
            step: 3,
            title: 'The Audience & Differentiation Map',
            description: 'Separates the brand’s tangible competitive advantages (assets, community, proprietary data) from soft claims like “great service,” and distinguishes Users from Buyers within a client organization.',
            image: '/frameworks/brand-blueprint/3.png',
            imageAlt: 'The Audience & Differentiation Map',
        },
        {
            step: 4,
            title: 'The Voice Map',
            description: 'Plots the brand across tone options (Straightforward, By-the-book, Authoritative, Warmer/Human, Bold/Challenging, Helpful-but-Challenging, Bold-yet-Nice) and emotional zones (Security, Relief from Overwhelm, Empowerment, ROI Reassurance, Clarity, Freedom to Focus, Reliability), each anchored to real B2B brand examples.',
            image: '/frameworks/brand-blueprint/4.png',
            imageAlt: 'The Voice Map',
            platforms: [
                { angle: 'Tone Options', platform: 'Authoritative / Warm / Bold', icon: '🗣️' },
                { angle: 'Emotional Zones', platform: 'Security / Relief / Clarity', icon: '❤️' },
            ],
        },
    ]
            ...
            <section className="pt-32 pb-16 md:pb-24 px-6 relative z-10">
                <AnimatedSection className="max-w-5xl mx-auto text-center">
                    ...
                    <motion.div variants={fadeUp} className="flex items-center justify-center gap-2 mb-8 text-sm text-gray-500">
                        ...
                        <span>/</span>
                        <span className="text-white/70">Brand Blueprint</span>
                    </motion.div>
                    ...
                    <motion.div variants={fadeUp} custom={1} className="mb-6">
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight leading-[0.95]">
                            <span className="text-white">THE RENOWEB</span>
                            <br />
                    ...
                    <motion.p variants={fadeUp} custom={3} className="text-lg md:text-xl text-gray-400 mb-6 max-w-3xl mx-auto leading-relaxed">
                        A structured diagnostic that forces a business to articulate its Why/What/How, brand attributes, benefit statements, and messaging before a single piece of website copy or ad creative is written — replacing guesswork with a documented foundation.
                    </motion.p>
                        ...
                        <div className="relative bg-gradient-to-r from-[#023dbb]/15 to-[#4ec8ef]/10 border border-[#4460ef]/20 rounded-2xl p-6 md:p-8">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-300 leading-relaxed text-base md:text-lg">
                                    You can’t build message-market fit on guesswork. We <span className="text-white font-semibold">document your brand’s blueprint</span> before we build on top of it.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <motion.p variants={fadeUp} custom={1} className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                                Stop guessing what works. Let us document your brand’s blueprint before we build on top of it.
                            </motion.p>
