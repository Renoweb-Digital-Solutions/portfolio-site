...
/* ════════════════════════════════════════════════════════════════════
   RENOWEB PRISM PAGE
   ════════════════════════════════════════════════════════════════════ */
export default function RenowebPrismPage() {
    ...
    const sections = [
        {
            step: 1,
            title: 'Capture Layer',
            description: 'A founder logs any meaningful moment — an event, a conversation, a mistake, an epiphany — in under 60 seconds, before the memory and emotion fade.',
            image: '/frameworks/renoweb-prism/1.png',
            imageAlt: 'Renoweb Prism Capture Layer — moment logging interface',
        },
        {
            step: 2,
            title: 'Distillation Layer',
            description: 'Every entry is broken into four core components: the Event itself, Who Was Involved, the Essence (the universal truth in 15 words or less), and the Takeaway.',
            image: '/frameworks/renoweb-prism/2.png',
            imageAlt: 'Renoweb Prism Distillation Layer — event breakdown',
        },
        {
            step: 3,
            title: 'Angle Layer',
            titleSuffix: '+ Viral Possibility',
            description: 'The 15-angle library is applied to select 1–3 angles that fit the moment. Every selected angle has a viral possibility mapped — High or Very High.',
            ...
            image: '/frameworks/renoweb-prism/3.png',
            imageAlt: 'Renoweb Prism Angle Layer — content angle selection and viral mapping',
        },
        {
            step: 4,
            title: 'Trigger Phrase',
            description: 'A matching trigger phrase based on the Content Angle and Viral Possibility builds the framework for the content title or the Hook.',
            image: '/frameworks/renoweb-prism/4.png',
            imageAlt: 'Renoweb Prism Trigger Phrase — hook generation framework',
        },
        {
            step: 5,
            title: 'Content Title / Hook',
            description: 'Based on all previous inputs — the captured moment, distilled essence, selected angles, viral mapping, and trigger phrases — the content title and hook are finally created. This is where raw founder experience becomes a scroll-stopping opening line.',
            image: null,
        },
        {
            step: 6,
            title: 'Platform Routing',
            description: 'Each angle carries a "best platform" tag for maximum reach. The system routes your content to where it performs best.',
            platforms: [
                { angle: 'Hot Take & Open Loop', platform: 'X (Twitter)', icon: '𝕏' },
                { angle: 'Framework & Story→Principle', platform: 'LinkedIn', icon: 'in' },
                { angle: 'Identity & Transformation', platform: 'Instagram', icon: '📸' },
                { angle: 'Framework & Transformation', platform: 'YouTube', icon: '▶' },
            ],
            image: '/frameworks/renoweb-prism/5.png',
            imageAlt: 'Renoweb Prism Platform Routing — content distribution mapping',
        },
    ]
            ...
            <section className="pt-32 pb-16 md:pb-24 px-6 relative z-10">
                <AnimatedSection className="max-w-5xl mx-auto text-center">
                    ...
                    <motion.div variants={fadeUp} className="flex items-center justify-center gap-2 mb-8 text-sm text-gray-500">
                        ...
                        <span>/</span>
                        <span className="text-white/70">Renoweb Prism</span>
                    </motion.div>
                    ...
                    <motion.div variants={fadeUp} custom={1} className="mb-6">
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight leading-[0.95]">
                            <span className="text-white">RENOWEB</span>
                            <br />
                    ...
                    <motion.p variants={fadeUp} custom={2} className="text-lg md:text-xl text-[#4ec8ef]/80 font-medium mb-6 tracking-wide">
                        Ultimate Founder-Voice Content Creator System
                    </motion.p>
                    ...
                    <motion.p variants={fadeUp} custom={3} className="text-lg md:text-xl text-gray-400 mb-6 max-w-3xl mx-auto leading-relaxed">
                        A raw-moment capture and conversion system that stops founders from losing their best content ideas to a busy day, and turns lived moments into publishable posts using a repeatable Story Arc.
                    </motion.p>
                        ...
                        <div className="relative bg-gradient-to-r from-[#023dbb]/15 to-[#4ec8ef]/10 border border-[#4460ef]/20 rounded-2xl p-6 md:p-8">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-300 leading-relaxed text-base md:text-lg">
                                    Ghostwriting that doesn&apos;t sound like you doesn&apos;t build trust. Prism is built to <span className="text-white font-semibold">protect your real voice</span>.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    {sections.map((section, index) => {
                        ...
                        return (
                            <React.Fragment key={section.step}>
                                ...
                                {!hasImage ? (
                                    /* ── Text-Only Card (Content Title/Hook) ── */
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <motion.p variants={fadeUp} custom={1} className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                                Stop losing your best ideas to a busy day. Let Prism turn your real moments into content that actually sounds like you.
                            </motion.p>
