        ...
        <div className="min-h-screen bg-black text-white relative overflow-hidden">
            ...
            <section className="py-20 px-6 relative z-10">
                <AnimatedSection className="max-w-5xl mx-auto">
                    <motion.div
                        variants={scaleIn}
                        className="bg-gradient-to-br from-blue-600/10 via-purple-600/10 to-blue-800/10 border border-blue-600/30 rounded-3xl p-12"
                    >
                            ...
                            {benefits.map((benefit, index) => (
                                ...
                                >
                                    <motion.div
                                        ...
                                        className="flex-shrink-0 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center transition"
                                    >
            ...
            <section className="py-20 px-6 relative z-10">
                <AnimatedSection className="max-w-4xl mx-auto text-center">
                    <motion.div
                        variants={scaleIn}
                        className="bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-blue-800/20 border border-blue-600/40 rounded-3xl p-12 relative overflow-hidden"
                    >
