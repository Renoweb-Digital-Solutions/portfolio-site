                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        <div className="flex justify-center lg:justify-start">
                            <Image width={250} height={250} src="/renowebLogo.png" alt="renoweb logo" />
                        </div>
                    ...
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-[#3877F0] font-medium mb-7">Renoweb</h4>
                        <ul className="text-sm text-[#fffbef] transition-all duration-500">
                            <li className="mb-6"><a href="javascript:;" className="hover:text-[#3877F0]">Home</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" hover:text-[#3877F0]">About</a></li>
                            <li><a href="javascript:;" className=" hover:text-[#3877F0]">Pricing</a></li>
                        </ul>
                    </div>
                    {/* <!--End Col--> */}
                    <div className="lg:mx-auto text-left ">
                    ...
                    {/* <!--End Col--> */}
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-[#3877F0] font-medium mb-7">Support</h4>
                        <ul className="text-sm text-[#fffbef] transition-all duration-500">
                            <li className="mb-6"><a href="javascript:;" className=" hover:text-[#3877F0]">Customer Support</a></li>
                            <li className="mb-6"><a href="javascript:;" className="  hover:text-[#3877F0]">Terms & Conditions</a></li>
                            <li ><a href="javascript:;" className="  hover:text-[#3877F0]">Privacy Policy</a></li>
                        </ul>
                    </div>
                    {/* <!--End Col--> */}
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-[#3877F0] font-medium mb-7">Contact</h4>
                        <p className="text-sm text-[#fffbef] leading-6 mb-7">Contact to know more about us</p>
                        ...
                        <a href="javascript:;" className="py-2.5 px-5 h-9 block w-fit bg-[#3877F0] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-[#003FB9] lg:mx-0">
                            Contact us
                        </a>
                    </div>
                </div>
