...
const Footer = () => {
    return (
        <footer className="w-full text-white bg-black relative overflow-hidden">
                            ...
                            <div className="lg:col-span-8">
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-3">
                                            <li><Link href="/products/growth-os" className="text-gray-400 hover:text-blue-400 text-sm transition">Growth OS</Link></li>
                                            <li><Link href="/products/quantum-accelerator" className="text-gray-400 hover:text-blue-400 text-sm transition">Quantum Accelerator</Link></li>
                                            <li><Link href="/products" className="text-gray-400 hover:text-blue-400 text-sm transition">All Products</Link></li>
                                            <li><Link href="/pricing" className="text-gray-400 hover:text-blue-400 text-sm transition">Pricing</Link></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-3">
                                            <li><Link href="/research-hub" className="text-gray-400 hover:text-blue-400 text-sm transition">Research Hub</Link></li>
                                            <li><Link href="/blog" className="text-gray-400 hover:text-blue-400 text-sm transition">Blog</Link></li>
                                            <li><Link href="/case-studies" className="text-gray-400 hover:text-blue-400 text-sm transition">Case Studies</Link></li>
                                            <li><Link href="/portfolio" className="text-gray-400 hover:text-blue-400 text-sm transition">Projects</Link></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-3">
                                            <li><Link href="/legal?policy=privacy" className="text-gray-400 hover:text-blue-400 text-sm transition">Privacy Policy</Link></li>
                                            <li><Link href="/legal?policy=terms" className="text-gray-400 hover:text-blue-400 text-sm transition">Terms of Service</Link></li>
                                            <li><Link href="/legal?policy=cancellation" className="text-gray-400 hover:text-blue-400 text-sm transition">Cancellation</Link></li>
                                            <li><Link href="/legal?policy=shipping" className="text-gray-400 hover:text-blue-400 text-sm transition">Shipping</Link></li>
                                            <li><Link href="/sitemap.xml" className="text-gray-400 hover:text-blue-400 text-sm transition">Sitemap</Link></li>
                    ...
                    <div className="max-w-7xl mx-auto px-6 py-6">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                            ...
                            <p className="text-gray-400 text-sm">
                                © {new Date().getFullYear()} Renoweb. All rights reserved.
                            </p>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                >
                                    <svg className="w-4 h-4 text-gray-400 group-hover:text-blue-400 transition" viewBox="0 0 16 16" fill="currentColor">
                                ...
                                <a
                                    ...
                                    aria-label="Facebook"
                                >
                                    <svg className="w-4 h-4 text-gray-400 group-hover:text-blue-400 transition" viewBox="0 0 8 14" fill="currentColor">
